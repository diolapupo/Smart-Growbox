...
# 1 "./../../EEE307/PIC16F877a_I2C.h" 1
# 10 "./../../EEE307/PIC16F877a_I2C.h"
void I2C_Initialize(const unsigned long feq_K)
{
  SSPCON = 0b00101000;
  SSPCON2 = 0b00000000;
  SSPSTAT = 0b00000000;
  SSPADD = (16000000/(4*feq_K))-1;
  TRISC3 = 1; TRISC4 = 1;
}
...
# 1 "./../../EEE307/PIC16F877a_DS3231.h" 1
# 16 "./../../EEE307/PIC16F877a_DS3231.h"
...
void dht11_init(){
 ...
 if (PORTBbits.RB4 == 0){
 _delay((unsigned long)((80)*(16000000/4000000.0)));
 if (PORTBbits.RB4 == 1){
    Check_bit = 1;
 }
